---
title: "Differential Expression Analysis - AAV old samples"
date: "`r Sys.Date()`"
...
experiment <- "12-21-2023-DE_Analysis_AAV_old" # results with pvalue of 0.01
## experiment <- "06-08-2023-DE_Analysis_AAV_old" # results with pvalue of 0.01
...
metadataPath <- file.path(data_path, "aav_old_samples.csv")
skipLines <- 0
sampleCol <- "Sample"
...
selectGenes[["early"]] <- sigDET_early$gene_name[1:40]
